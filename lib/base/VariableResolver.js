...
const extendList = (target, source, separator) => {
  ...
  // Both target and source may themselves be separator-joined lists (e.g. 'Null|Number').
  // Split both sides, deduplicate, and rejoin so we never produce tokens like 'Null|Null|Number'.
