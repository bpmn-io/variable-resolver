...
export class BaseVariableResolver {
  ...
  async _getWrittenVariablesForElement(element) {
    const bo = getBusinessObject(element);
...
function normalizeGetVariablesForElementOptions(options = {}) {
  const hasRead = Object.prototype.hasOwnProperty.call(options, 'read');
  const hasWritten = Object.prototype.hasOwnProperty.call(options, 'written');
